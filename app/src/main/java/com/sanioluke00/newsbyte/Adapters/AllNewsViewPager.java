...
public class AllNewsViewPager extends ViewPager {
    public AllNewsViewPager(@NonNull Context context) {
        super(context);
        init();
    }

    public AllNewsViewPager(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
